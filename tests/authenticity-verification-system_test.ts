...
Clarinet.test({
    ...
    async fn(chain: Chain, accounts: Map<string, Account>) {
        ...
        let block = chain.mineBlock([
            Tx.contractCall("authenticity-verification-system", "get-contract-info", [], deployer.address),
        ]);
...
Clarinet.test({
    ...
    async fn(chain: Chain, accounts: Map<string, Account>) {
        ...
        let block2 = chain.mineBlock([
            Tx.contractCall("authenticity-verification-system", "get-record", [types.uint(1)], wallet1.address),
        ]);
...
Clarinet.test({
    ...
    async fn(chain: Chain, accounts: Map<string, Account>) {
        ...
        // Pause contract
        let block = chain.mineBlock([
            Tx.contractCall("authenticity-verification-system", "emergency-pause", [], deployer.address),
        ]);
