...
Clarinet.test({
    ...
    async fn(chain: Chain, accounts: Map<string, Account>) {
        ...
        let block = chain.mineBlock([
            Tx.contractCall("product-lifecycle-tracker", "get-contract-info", [], deployer.address),
        ]);
...
Clarinet.test({
    ...
    async fn(chain: Chain, accounts: Map<string, Account>) {
        ...
        let block2 = chain.mineBlock([
            Tx.contractCall("product-lifecycle-tracker", "get-record", [types.uint(1)], wallet1.address),
        ]);
...
Clarinet.test({
    ...
    async fn(chain: Chain, accounts: Map<string, Account>) {
        ...
        // Pause contract
        let block = chain.mineBlock([
            Tx.contractCall("product-lifecycle-tracker", "emergency-pause", [], deployer.address),
        ]);
